...
public class EstudianteResource {
    ...
    public List<EstudianteRepresentation> listarTodos(){
        List<EstudianteRepresentation> test = new ArrayList<>();

        for(EstudianteRepresentation e: estudianteService.listarTodos()){
            this.construirLinks(e);
            test.add(e);
        }
    ...
    public List<EstudianteRepresentation> buscarPorProvincia(@QueryParam("provincia") String provincia, @QueryParam("genero") String genero){
        System.err.println("LISTAR TODOS EM PROVINCIA");
